...
function addMessage(severity, message, notFromLabviewport) {
    ...
    if ($("#lab-viewport").length) {
        if (!$('#alert_container').length) {
            ...
            $('body').append('<div id="alert_container"><b><i class="fa fa-bell-o"></i> 通知<i id="alert_container_close" class="pull-right fa fa-times" style="color: red; margin: 5px;cursor:pointer;"></b><div class="inner"></div></div></div>');
        }
...
function printFormCustomShape(values) {
  ...
  var html = '<form id="main-modal" class="container col-md-12 col-lg-12 custom-shape-form">' +
        ...
        '<label class="col-md-3 control-label form-group-addon">类型</label>' +
        '<div class="col-md-5">' +
        ...
        '</div> <br>' +
        '<div class="col-md-8 col-md-offset-1 form-group">' +
        '<label class="col-md-3 control-label form-group-addon">名称</label>' +
        '<div class="col-md-5">' +
        '<input type="text" class="form-control shape_name" placeholder="Name">' +
        '</div>' +
        '</div> <br>' +
        '<div class="col-md-8 col-md-offset-1 form-group">' +
        '<label class="col-md-3 control-label form-group-addon">边框类型</label>' +
        '<div class="col-md-5">' +
        ...
        '</div> <br>' +
        '<div class="col-md-8 col-md-offset-1 form-group">' +
        '<label class="col-md-3 control-label form-group-addon">边框宽度</label>' +
        '<div class="col-md-5">' +
        '<input type="number" min="0" value="5" class="form-control shape_border_width">' +
        '</div>' +
        '</div> <br>' +
        '<div class="col-md-8 col-md-offset-1 form-group">' +
        '<label class="col-md-3 control-label form-group-addon">边框颜色</label>' +
        '<div class="col-md-5">' +
        '<input type="color" class="form-control shape_border_color">' +
        '</div>' +
        '</div> <br>' +
        '<div class="col-md-8 col-md-offset-1 form-group">' +
        '<label class="col-md-3 control-label form-group-addon">背景颜色</label>' +
        '<div class="col-md-5">' +
...
function displayPictureForm(picture_id) {
    ...
    if (picture_id == null) {
        ...
        // Name
        form += '<div class="form-group"><label class="col-md-3 control-label">名称</label><div class="col-md-5"><input type="text" class="form-control-static" name="picture[name]" value=""/></div></div>';
        // File (add only)
        form += '<div class="form-group"><label class="col-md-3 control-label">图片</label><div class="col-md-5"><input type="file" name="picture[file]" value=""/></div></div>';
        // Footer
    ...
    $.when(
        ...
        $('#'+info.source.id).addClass("startNode")
          ...
          linktargetdata['icon'] = ( linktargetdata['type'] == "bridge")  ? "../lan.png" : "../cloud.png"
              ...
              title = '在' + linksourcedata['name'] + '和' + linktargetdata['name']  + '之间建立连接' ;
                 ...
                 if ( (sourceif['ethernet'][key]['network_id'] == 0 )  && ( linksourcedata['selectedif'] == '') ) {
                  ...
                  html = '<form id="addConn" class="addConn-form">' +
                           ...
                           '<div class="row">' +
                            ...
                            '<div class="col-md-8">' +
                                '<div class="form-group">' +
                                    '<label>源设备ID: '+linksourcedata['id']+'</label>' +
                                    '<p style="margin:0px;"></p>' +
                                    '<label>源设备名称: '+ linksourcedata['name'] +'</label>' +
                                    '<p style="">类型 - '+ ((linksourcetype == 'net') ? 'Network' : '节点') +'</p>' +
                                '</div>' +
                                '<div class="form-group">' +
                                    '<div class="form-group ' + (( linksourcetype == 'net') ? 'hidden' : '')  +  '">'  +
                                        '<label>选择' + linksourcedata['name'] + '的接口' +'</label>' +
                                    ...
                                    '</div>' +
                                    '<div class="form-group">' +
                                        '<label>目的地设备 ID: ' + linktargetdata['id'] + '</label>' +
                                        '<p style="margin:0px;"></p>' +
                                        '<label>目的地设备名称: ' + linktargetdata['name'] + '</label>' +
                                        '<p style="text-muted">类型 - '+ ((linktargettype == 'net') ? 'Network' : '节点') +'</p>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="form-group">' +
                                    '<div class="form-group ' + (( linktargettype == 'net') ? 'hidden' : '')  +  '">'  +
                                        '<label>选择'+ linktargetdata['name'] + '的接口' +'</label>' +
